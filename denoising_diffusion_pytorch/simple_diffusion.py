...
class GaussianDiffusion(nn.Module):
    ...
    def p_mean_variance(self, x, cond, time, time_next, return_history=False):
        ...
        preds = self.model(x, batch_log_snr, cond)
        # try:
        #     _, _, preds = self.model(x, batch_log_snr, cond)
        # except ValueError:
    ...
    def save_img(self, img, name, type):
        ...
        img.save(rf"E:\hr\work\Diff-UNet-main\BraTS2020\test_results\temp\{type}_{name}.jpg")
